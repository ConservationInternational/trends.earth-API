...
class TestGcsIamService:
    ...
    def test_grant_calls_set_iam_policy(self):
        """grant_user_bucket_write should set IAM policy with correct member."""
    ...
    def test_grant_idempotent_when_binding_exists(self):
        ...
        member = "user:existing@example.com"
        mock_bucket = Mock()
        mock_policy = Mock()
        mock_policy.bindings = [
        ...
        with (
            ...
            grant_user_bucket_write("existing@example.com", "ldmt")

        mock_bucket.set_iam_policy.assert_not_called()

    def test_revoke_removes_member(self):
        """revoke_user_bucket_write should remove member and call set_iam_policy."""
        from gefapi.services.gcs_iam_service import (
            revoke_user_bucket_write,
        )
        ...
        with (
            ...
            revoke_user_bucket_write("test@example.com", "ldmt")
    ...
    def test_revoke_idempotent_when_no_binding(self):
        ...
        with (
            ...
            revoke_user_bucket_write("nobody@example.com", "ldmt")
    ...
    def test_missing_service_account_json_logs_warning(self, caplog):
        ...
        with (
            ...
            # Should not raise.
            grant_user_bucket_write("test@example.com", "ldmt")
