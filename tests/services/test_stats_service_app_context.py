...
class TestStatsServiceAppContextFix:
    ...
    def test_get_from_cache_or_execute_with_app_context(
        self, mock_has_app_context, mock_get_redis_cache
    ):
        ...
        # Execute
        result = StatsService._get_from_cache_or_execute(
            "test_key", mock_execution_func
        )
    ...
    def test_get_from_cache_or_execute_without_app_context(
        self, mock_app, mock_has_app_context, mock_get_redis_cache
    ):
    ...
    @patch("gefapi.services.stats_service.has_app_context")
    @patch("gefapi.services.stats_service.app")
    def test_get_from_cache_or_execute_handles_exception_in_context(
        self, mock_app, mock_has_app_context, mock_get_redis_cache
    ):
    ...
    @patch("gefapi.services.stats_service.has_app_context")
    @patch("gefapi.services.stats_service.app")
    def test_get_from_cache_or_execute_logs_errors_correctly(
        self, mock_app, mock_has_app_context, mock_get_redis_cache, mock_logger
    ):
        ...
        with pytest.raises(RuntimeError):
            StatsService._get_from_cache_or_execute(
                "test_cache_key", mock_execution_func
            )
