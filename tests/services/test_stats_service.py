...
class TestStatsService:
    ...
    def test_cache_key_generation(self, mock_get_redis_cache):
        ...
        key2 = StatsService._get_cache_key('test_method', param1='value1', param2='value2')
        assert key2 == 'stats_service:test_method:param1=value1_param2=value2'
        
        # Test parameter ordering consistency
        key3 = StatsService._get_cache_key('test_method', param2='value2', param1='value1')
    ...
    def test_cache_miss_and_set(self, mock_db, mock_get_redis_cache):
        ...
        self.mock_redis.set.assert_called_once_with(cache_key, self.sample_summary_data, ttl=300)
    ...
    def test_get_dashboard_stats_with_cache(self, mock_db, mock_get_redis_cache):
        ...
        # Execute
        result = StatsService.get_dashboard_stats(period='last_month', include=['summary', 'trends'])
        
        # Verify
        assert result == expected_result
        expected_cache_key = 'stats_service:get_dashboard_stats:include=summary,trends_period=last_month'
    ...
    def test_get_user_stats_with_cache(self, mock_db, mock_get_redis_cache):
        ...
        # Verify
        assert result == expected_result
        expected_cache_key = 'stats_service:get_user_stats:country=USA_group_by=month_period=last_year'
        self.mock_redis.get.assert_called_once_with(expected_cache_key)
    ...
    def test_clear_cache_all(self, mock_get_redis_cache):
        ...
        self.mock_redis.client.scan_iter.assert_called_once_with(match='stats_service:*')
    ...
    def test_clear_cache_pattern(self, mock_get_redis_cache):
        ...
        # Verify
        assert result is True
        self.mock_redis.client.scan_iter.assert_called_once_with(match='stats_service:*summary*')
    ...
    def test_normalize_task_name(self):
        ...
        assert StatsService._normalize_task_name('productivity-v2.1.0') == 'productivity'
        assert StatsService._normalize_task_name('land-cover-v1.5') == 'land-cover'
        
        # Test deprecated name mapping
        assert StatsService._normalize_task_name('sdg-sub-indicators') == 'sdg-15-3-1-sub-indicators'
        assert StatsService._normalize_task_name('vegetation-productivity') == 'productivity'
...
class TestStatsServiceIntegration:
    ...
    @patch('gefapi.services.stats_service.get_redis_cache')
    def test_get_summary_stats_database_integration(self, mock_get_redis_cache, app, db_session):
    ...
    @patch('gefapi.services.stats_service.get_redis_cache')
    def test_get_dashboard_stats_database_integration(self, mock_get_redis_cache, app, db_session):
