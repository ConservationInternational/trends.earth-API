...
class TestStatsAPIEndpoints:
    ...
    def test_dashboard_stats_requires_authentication(self, client, auth_headers_superadmin):
        """Test that dashboard stats endpoint requires authentication."""
        response = client.get('/api/v1/stats/dashboard')
        assert response.status_code == 401
        
    def test_execution_stats_requires_authentication(self, client, auth_headers_superadmin):
    ...
    def test_cache_endpoints_require_authentication(self, client, auth_headers_superadmin):
    ...
    def test_dashboard_stats_requires_superadmin(self, mock_is_superadmin, client, auth_headers_user):
    ...
    def test_dashboard_stats_success(self, mock_get_stats, mock_is_superadmin, client, auth_headers_superadmin):
        ...
        response = client.get('/api/v1/stats/dashboard', headers=auth_headers_superadmin)
    ...
    @patch('gefapi.utils.permissions.is_superadmin')
    @patch.object(StatsService, 'get_dashboard_stats')
    def test_dashboard_stats_with_parameters(self, mock_get_stats, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    @patch('gefapi.utils.permissions.is_superadmin')
    def test_dashboard_stats_invalid_period(self, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    @patch('gefapi.utils.permissions.is_superadmin')
    def test_dashboard_stats_invalid_include(self, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    def test_execution_stats_success(self, mock_get_stats, mock_is_superadmin, client, auth_headers_superadmin):
        """Test successful execution stats retrieval."""
        mock_is_superadmin.return_value = True
        mock_get_stats.return_value = self.sample_execution_stats
        
        response = client.get('/api/v1/stats/executions', headers=auth_headers_superadmin)
    ...
    @patch('gefapi.utils.permissions.is_superadmin')
    @patch.object(StatsService, 'get_execution_stats')
    def test_execution_stats_with_filters(self, mock_get_stats, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    @patch('gefapi.utils.permissions.is_superadmin')
    def test_execution_stats_invalid_status(self, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    def test_user_stats_success(self, mock_get_stats, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    @patch('gefapi.utils.permissions.is_superadmin')
    @patch.object(StatsService, 'get_user_stats')
    def test_user_stats_with_country_filter(self, mock_get_stats, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    def test_health_check_success(self, mock_get_summary, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    def test_get_cache_info_success(self, mock_get_cache_info, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    def test_clear_cache_success(self, mock_clear_cache, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    @patch('gefapi.utils.permissions.is_superadmin')
    @patch.object(StatsService, 'clear_cache')
    def test_clear_cache_with_pattern(self, mock_clear_cache, mock_is_superadmin, client, auth_headers_superadmin):
        """Test clear cache with pattern."""
        mock_is_superadmin.return_value = True
        mock_clear_cache.return_value = True
        
        response = client.delete('/api/v1/stats/cache?pattern=summary', headers=auth_headers_superadmin)
    ...
    @patch('gefapi.utils.permissions.is_superadmin')
    @patch.object(StatsService, 'clear_cache')
    def test_clear_cache_failure(self, mock_clear_cache, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    @patch('gefapi.utils.permissions.is_superadmin')
    @patch.object(StatsService, 'get_dashboard_stats')
    def test_dashboard_stats_service_error(self, mock_get_stats, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    @patch('gefapi.utils.permissions.is_superadmin')
    @patch.object(StatsService, 'get_execution_stats')
    def test_execution_stats_service_error(self, mock_get_stats, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    @patch('gefapi.utils.permissions.is_superadmin')
    @patch.object(StatsService, '_get_summary_stats')
    def test_health_check_service_error(self, mock_get_summary, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    @patch('gefapi.utils.permissions.is_superadmin')
    @patch.object(StatsService, 'get_dashboard_stats')
    def test_concurrent_requests_simulation(self, mock_get_stats, mock_is_superadmin, client, auth_headers_superadmin):
    ...
    @patch('gefapi.utils.permissions.is_superadmin')
    @patch.object(StatsService, 'get_dashboard_stats')
    def test_large_response_handling(self, mock_get_stats, mock_is_superadmin, client, auth_headers_superadmin):
