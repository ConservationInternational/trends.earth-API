...
class TestExecutionUpdateAuthFix:
    ...
    def test_user_can_update_own_execution(self, client, auth_headers_user):
        ...
        results_data = {
            "results": {
                ...
                "metrics": {"area_processed": 1000, "processing_time": 45.2},
                "status": "success",
            },
            "status": "FINISHED",
        }
    ...
    def test_user_cannot_update_other_users_execution(
        ...
        results_data = {"results": {"unauthorized": "attempt"}, "status": "FINISHED"}
    ...
    def test_admin_can_update_any_execution(
        ...
        results_data = {"results": {"admin_update": "allowed"}, "status": "FINISHED"}
