...
class TestRollbarError1803Fix:
    ...
    def test_celery_task_db_access_without_app_context(self):
        ...
        with patch('gefapi.services.stats_service.app') as mock_app:
            with patch('gefapi.services.stats_service.db') as mock_db:
                with patch('gefapi.services.stats_service.get_redis_cache') as mock_redis:
                    ...
                    with patch('gefapi.services.stats_service.has_app_context', return_value=False):
                        ...
                        try:
                            ...
                            if "Working outside of application context" in str(e):
                                pytest.fail("❌ Fix did not work - still getting app context error")
                            else:
