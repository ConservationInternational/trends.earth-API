...
def create_codedeploy_service_role(iam_client):
    ...
    try:
        ...
        print(f"✅ Attached AWSCodeDeployRole policy")
    ...
    try:
        ...
        if e.response['Error']['Code'] == 'DeploymentGroupAlreadyExistsException':
            ...
            try:
                ...
                del deployment_config['tags']  # Can't update tags with update_deployment_group
...
def main(profile=None, region=None):
    ...
    print(f"    Tag Key: CodeDeploy-TrendsEarth-Production")
    print(f"    Tag Value: true")
    print("  For Staging instance:")
    print(f"    Tag Key: CodeDeploy-TrendsEarth-Staging")
    print(f"    Tag Value: true")
