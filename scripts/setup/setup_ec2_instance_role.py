    ...
    custom_policy = {
        ...
        "Statement": [
            ...
            },
            {
                ...
                "Resource": [
                    "arn:aws:s3:::trendsearth-api-deployments",
                    "arn:aws:s3:::trendsearth-api-deployments/*",
                ],
            },
            {
...
def create_instance_profile(iam_client):
    ...
    try:
        ...
        if e.response["Error"]["Code"] == "LimitExceeded":
            print("ℹ️  Role already attached to instance profile")
        else:
...
def main(profile=None, region=None):
    ...
    print("       --instance-id <YOUR_INSTANCE_ID> \\")
    ...
    print("   # First, get the current association ID")
    print("   aws ec2 describe-iam-instance-profile-associations \\")
    print("       --filters Name=instance-id,Values=<YOUR_INSTANCE_ID>")
    print("   # Then replace it")
    print("   aws ec2 replace-iam-instance-profile-association \\")
