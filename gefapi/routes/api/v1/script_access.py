...
def setup_script_access_routes(app):
    """Setup script access control routes"""

    @app.route("/api/v1/script/<script_id>/access", methods=["GET"])
    @jwt_required()
    ...
    @app.route("/api/v1/script/<script_id>/access/roles", methods=["PUT"])
    @jwt_required()
    ...
    @app.route("/api/v1/script/<script_id>/access/users", methods=["PUT"])
    @jwt_required()
    ...
    @app.route("/api/v1/script/<script_id>/access/users/<user_id>", methods=["POST"])
    @jwt_required()
    ...
    @app.route("/api/v1/script/<script_id>/access/users/<user_id>", methods=["DELETE"])
    @jwt_required()
    ...
    @app.route("/api/v1/script/<script_id>/access/roles/<role>", methods=["POST"])
    @jwt_required()
    ...
    @app.route("/api/v1/script/<script_id>/access/roles/<role>", methods=["DELETE"])
    @jwt_required()
    ...
    @app.route("/api/v1/script/<script_id>/access", methods=["DELETE"])
    @jwt_required()
