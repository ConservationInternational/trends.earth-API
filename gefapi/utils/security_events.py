...
def log_authentication_event(success: bool, email: str, reason: Optional[str] = None) -> None:
    """
...
def log_admin_action(admin_user_id: str, admin_email: str, action: str, target_user_id: Optional[str] = None) -> None:
    """
...
def log_suspicious_activity(description: str, user_id: Optional[str] = None, user_email: Optional[str] = None) -> None:
    """
...
def log_password_event(event_type: str, user_id: str, user_email: str, admin_action: bool = False) -> None:
    """
